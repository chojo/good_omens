...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13544 = (0);while(true){
var m_13545 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13545 == null))
{} else
{m_13545.call(null);
if((count_13544 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13546 = (count_13544 + (1));
count_13544 = G__13546;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3540__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3540__auto__)
