...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13550 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13550 = (function (val,box,meta13551){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13550.cljs$lang$type = true;
cljs.core.async.impl.channels.t13550.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13550";
cljs.core.async.impl.channels.t13550.cljs$lang$ctorPrWriter = (function (this__4119__auto__,writer__4120__auto__,opt__4121__auto__){return cljs.core._write.call(null,writer__4120__auto__,"cljs.core.async.impl.channels/t13550");
});
cljs.core.async.impl.channels.t13550.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13550.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13552){var self__ = this;
var _13552__$1 = this;return self__.meta13551;
});
cljs.core.async.impl.channels.t13550.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13552,meta13551__$1){var self__ = this;
var _13552__$1 = this;return (new cljs.core.async.impl.channels.t13550(self__.val,self__.box,meta13551__$1));
});
cljs.core.async.impl.channels.__GT_t13550 = (function __GT_t13550(val__$1,box__$1,meta13551){return (new cljs.core.async.impl.channels.t13550(val__$1,box__$1,meta13551));
});
}
return (new cljs.core.async.impl.channels.t13550(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4122__auto__,writer__4123__auto__,opts__4124__auto__){return cljs.core._write.call(null,writer__4123__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4119__auto__,writer__4120__auto__,opt__4121__auto__){return cljs.core._write.call(null,writer__4120__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13553 = self__.takes.pop();if((taker_13553 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13553))
{var take_cb_13554 = cljs.core.async.impl.protocols.commit.call(null,taker_13553);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13554,taker_13553,this$__$1){
return (function (){return take_cb_13554.call(null,null);
});})(take_cb_13554,taker_13553,this$__$1))
);
} else
{}
{
