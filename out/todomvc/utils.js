...
{return localStorage.setItem(ns,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(edn)));
} else
...
;
todomvc.utils.hidden = (function hidden(is_hidden){if(cljs.core.truth_(is_hidden))
{return {"display": "none"};
} else
{return {};
}
