...
{{
var G__13790 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13790;
continue;
}
} else
...
{var pred__13794 = cljs.core._EQ_;var expr__13795 = limit;if(cljs.core.truth_(pred__13794.call(null,(1),expr__13795)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13794.call(null,(2),expr__13795)))
...
var G__13797 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13798 = (limit__$1 - (1));
var G__13799 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__13797;
limit__$1 = G__13798;
parts = G__13799;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___13801 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13801))
{var replacement_13802 = temp__4124__auto___13801;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13802)));
} else
{buffer.append(ch);
}
{
var G__13803 = (index + (1));
index = G__13803;
continue;
}
}
